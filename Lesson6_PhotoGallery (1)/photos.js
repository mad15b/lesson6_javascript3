...
//declare variable for document element with id of rightarrow in the html document var rightarrown = document.getElementById("rightarrow");

//add an event handler to the specified document element (rightarrow)
//the rightArrow() function will executed when user clicks the the right navigation arrow
